function loadOrganizeIframe() {
    ...
    if (typeof organizeBrandId !== 'undefined' && organizeBrandId !== '') {
        iframeTag.setAttribute('src', 'https://register-dev.organize.org/?cobrand_id=' + organizeBrandId);
    }
    else {
...
function popupWindow() {
    url = 'https://register-dev.organize.org/?widget_id=' + organizeWidgetId;
    // Support for cobranding over widget
    if (typeof organizeBrandId !== 'undefined' && organizeBrandId !== '') {
        url = 'https://register-dev.organize.org/?cobrand_id=' + organizeBrandId;
    }
...
(function() {
    ...
    else
    {
        // Support for cobranding over widget
        if (typeof organizeBrandId !== 'undefined' && organizeBrandId !== '') {
            organizeRegistrationBtnTag.setAttribute('onclick', 'javascript: window.open(\'https://register-dev.organize.org/?cobrand_id=' + organizeBrandId + '\');');
        }
        else {
